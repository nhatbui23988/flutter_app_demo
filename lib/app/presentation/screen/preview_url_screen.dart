...
class PreviewUrlScreen extends StatefulWidget {
  const PreviewUrlScreen({Key? key}) : super(key: key);

  @override
  State<PreviewUrlScreen> createState() => _PreviewUrlLinkState();
}

class _PreviewUrlLinkState extends State<PreviewUrlScreen> {
  ...
  final String _url5 = 'https://speedcouple.net/?username=ed43b1ca-9da3-4598-93df-9646c712c1d5&type=USER';//"https://flutter.dev/";
  final String _url6 =
